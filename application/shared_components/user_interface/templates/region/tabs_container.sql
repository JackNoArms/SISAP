...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(52084049936845434407)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(52084050220403434406)
,p_plug_template_id=>wwv_flow_imp.id(52084049936845434407)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(52084050536840434406)
,p_plug_template_id=>wwv_flow_imp.id(52084049936845434407)
,p_name=>'Tabs'
