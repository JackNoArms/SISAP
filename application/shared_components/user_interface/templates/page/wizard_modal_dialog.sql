...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(52084016396542434447)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(52084016674333434446)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(52084017067388434446)
,p_page_template_id=>wwv_flow_imp.id(52084016396542434447)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(52084017295204434446)
,p_page_template_id=>wwv_flow_imp.id(52084016396542434447)
