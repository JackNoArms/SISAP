prompt --application/shared_components/navigation/lists/andamento_do_assistente_de_carga_de_dados_sisap_carga_002
begin
--   Manifest
...
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(44757339916367187233)
,p_name=>'Andamento do Assistente de Carga de Dados - SISAP_CARGA'
,p_list_status=>'PUBLIC'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(44757340370892187233)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(44757340713982187232)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(44757341103286187231)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(44757341526627187231)
